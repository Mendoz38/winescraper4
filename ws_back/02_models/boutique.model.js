const { pool, query } = require('../00_utils/db');
...
async function replaceBoutiqueRows({ boutique, rows = [], meta = {} }) {
  ...
  try {
    ...
    const vignerons = await query('SELECT domaine, dom_commerce, dom_commerce2 FROM vn_viticulteur');
...
module.exports = { replaceBoutiqueRows };
